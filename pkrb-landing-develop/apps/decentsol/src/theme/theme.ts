...
declare module "@mui/material/styles" {
  interface Theme {
    ...
    gradient: {
      background: React.CSSProperties["color"];
      greenTitle: React.CSSProperties["color"];
      greenOrangeTitle: React.CSSProperties["color"];
    };
  }
...
const theme = createTheme({
  ...
  common: {
    ...
    label: "#FDFDFD",
    body: "#0F325A",
    titleActive: DSOL_GREEN,
    green: DSOL_GREEN,
  },
  gradient: {
    background:
    "radial-gradient(50% 50% at 50% 50%, #272F32 0%, #08090A 100%)",
    greenTitle:
      "linear-gradient(180deg, #FF3334 0%, #F3B644 0.01%, #F3B644 100%)",
    greenOrangeTitle: "linear-gradient(180deg, #FF3334 0%, #F3B644 100%)",
  },
  typography: {
    fontFamily: [
      "Righteous",
